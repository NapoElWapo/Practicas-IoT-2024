 ...
 * Define Constants 
 ****************************************/ 
#define WIFISSID "Platillo en tierra" //WIFI SSID aqui 
#define PASSWORD "TostadasDeChongos69$" // WIFI pwd 
#define TOKEN "BBUS-CAiuDA7LHdZYqpDg6xQJp2Wqwp5DJu" // Ubidots TOKEN name el mismo que usamos en clase 
#define MQTT_CLIENT_NAME "celularuwu" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices 
#define VARIABLE_LABEL_temp "TemperaturaUwU" // Variable Temperatura 
#define VARIABLE_LABEL_hum "HumedadOwO" // Variable Humedad 
#define DEVICE_LABEL "Napo-esp32" // Nombre del dispositivo a crear 
...
void reconnect() { 
  ...
  while (!client.connected()) { 
    ...
    // Attemp to connect 
    if (client.connect(MQTT_CLIENT_NAME, TOKEN, "1234")) { 
